...
async function runPhoneCatalog(db, { log = console.log } = {}) {
  ...
  log(`Phone catalog seed complete: ${created} created, ${skipped} skipped, ${reactivated} reactivated`)
...
module.exports = { runPhoneCatalog, phones }
