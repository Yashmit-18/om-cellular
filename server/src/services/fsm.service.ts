...
export const RETURN_REQUEST_TRANSITIONS: TransitionMap = {
  RETURN_REQUESTED: ['ADMIN_REVIEW', 'RETURN_APPROVED', 'RETURN_REJECTED', 'CANCELLED'],
  ADMIN_REVIEW: ['RETURN_APPROVED', 'RETURN_REJECTED', 'CANCELLED'],
