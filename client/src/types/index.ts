...
export type OrderStatus = 'PENDING' | 'PAYMENT_CONFIRMED' | 'CONFIRMED' | 'PROCESSING' | 'READY_TO_SHIP' | 'SHIPPED' | 'OUT_FOR_DELIVERY' | 'DELIVERED' | 'CANCELLED' | 'CANCEL_REQUESTED' | 'FAILED' | 'RETURN_REQUESTED' | 'RETURN_APPROVED' | 'RETURNED' | 'REFUND_PENDING' | 'REFUNDED'
