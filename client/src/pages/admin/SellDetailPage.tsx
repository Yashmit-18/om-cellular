...
export default function AdminSellDetailPage() {
  ...
  const handleStatusUpdate = async (status: string) => {
    ...
    if (finalPrice && finalPrice !== '' && status === 'APPROVED') data.finalOfferedPrice = Number(finalPrice)
    if (finalPrice && finalPrice !== '' && status === 'UNDER_REVIEW') data.finalOfferedPrice = Number(finalPrice)
    setUpdating(true)
    try {
